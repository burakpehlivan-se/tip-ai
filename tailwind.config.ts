...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["var(--font-noto)", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "sans-serif"],
        heading: ["var(--font-figtree)", "var(--font-noto)", "sans-serif"],
      ...
      boxShadow: {
        ...
        brand: "rgba(20, 184, 166, 0.08) 0px 8px 24px",
      },
    },
  },
  plugins: [],
