...
export function vakaUret(
  ...
  // Genel hasta yanıtları — ilgili olmayan sorular için nötr yanıt
  const genelYanitlar: Record<string, string> = {
    AGRI_SIDDAT: "Ağrım var ama şiddeti hakkında net bir şey söyleyemem.",
    AGRI_SKALA: "Ağrım yok, 0.",
    AGRI_HAFIFLETEN: "Dinlenince biraz hafifliyor gibi.",
    AGRI_ARTIRAN: "Hareket edince artıyor gibi geliyor.",
    KARIN_AGRISI: "Karın ağrım yok.",
    BAS_AGRISI: "Baş ağrım yok.",
    SIRT_AGRISI: "Sırt ağrım yok.",
    EKLEM_AGRISI: "Eklem ağrım yok.",
    KITLE_HAREKET: "Hareket ettirince kaymıyor gibi, sabit duruyor.",
    BALGAM_MIKTAR: "Günde birkaç kez balgam geliyor.",
    ATES_SURE: "Ateşim birkaç gündür var.",
    NEFES_SURE: "Nefes darlığım bir süredir var.",
    YUZ_ODEM: "Yüzümde şişlik fark etmedim.",
    ISHAL: "İshalim yok.",
    BULANTI: "Bulantım yok.",
    KUSMA: "Kusmam yok.",
    TERLEME: "Terleme normal.",
    BAS_DONMESI: "Başım dönmüyor.",
    SES_KISIKLIGI: "Sesim normal.",
    YUTKUNMA: "Yutkunmam normal.",
    BASKA_HASTALIK: "Bilinen ek hastalığım yok.",
    SEYAHAT: "Yakın zamanda seyahat etmedim.",
    HASTANE_YATIS: "Daha önce hastanede yatmadım.",
    AMALIYAT: "Ameliyatım olmadı.",
    TRAVMA: "Travma geçirmedim.",
    ALKOL: "Alkol kullanmıyorum.",
    KALP_OYKUSU: "Kalp hastalığım yok.",
    BÖBREK_OYKUSU: "Böbrek hastalığım yok.",
    KARACIGER_OYKUSU: "Karaciğer hastalığım yok.",
    AGRI_KESICI: "Ara sıra ağrı kesici alıyorum.",
    ILAC_ALERJI: "Bilinen ilaç alerjim yok.",
    BESLENME: "Beslenmem normal.",
    UYKU: "Uyku düzenim normal.",
    MESLEK: "Çalışıyorum, ofis işi.",
    VITAL_SOLUNUM: "Solunum sayım 16/dakika.",
    VITAL_KILO: "Kilom normal sınırlarda.",
    VITAL_BOY: "Boyum 170 cm.",
    FIZIK_KALP: "Kalp sesleri normal, üfürüm yok.",
    FIZIK_AKCIGER: "Akciğer sesleri normal.",
    FIZIK_KARIN: "Karın muayenesi normal, hassasiyet yok.",
    FIZIK_DERI: "Deri muayenesi normal.",
    FIZIK_LENF: "Lenf nodları büyümemiş.",
    FIZIK_ODEM: "Ödem yok.",
    FIZIK_MUKOZA: "Mukozalar normal, nemli.",
    FIZIK_GOZ: "Göz muayenesi normal.",
    FIZIK_TIROID: "Tiroid muayenesi normal, büyüme yok.",
    FIZIK_MEME: "Meme muayenesi yapılmadı.",
    KANLI_KUSMA: "Hayır, kanlı kusmam yok.",
    KANLI_DISKI: "Hayır, kanlı dışkım yok.",
    ANI_KILO_KAYBI: "Ani bir kilo kaybım yok.",
    GECE_TERLEME: "Gece terlemem yok.",
    KONFUZYON: "Bilincim yerinde, kafam karışık değil.",
    SARARMA: "Gözlerimde sararma yok.",
    IDRAR_KAN: "İdrarımda kan görmüyorum.",
    PARMAK_COMAKLASMA: "Parmaklarımda çomaklaşma yok.",
    // Yeni form bazlı sorular için genel yanıtlar
    EPIGASTRIK_AGRI: "Epigastrik bölgede ağrı veya yanma hissetmiyorum.",
    RETROSTERNAL_AGRI: "Göğüs kemiğimin arkasında ağrı yok.",
    MEME_AGRI: "Mememde ağrı veya hassasiyet yok.",
    ANUS_AGRI: "Anüste ağrı veya yanma hissetmiyorum.",
    BATIN_KITLE: "Karnımda ele gelen kitle yok.",
    PRETIBIAL_ODEM: "Bacak ön yüzünde şişlik fark etmiyorum.",
    POLIFAJI: "Aşırı yeme isteğim yok, iştahım normal.",
    SICAK_INTOLERANS: "Sıcağa karşı intoleransım yok.",
    TITREME: "Titreme nöbetlerim olmadı.",
    ODINOFAJI: "Yutkunurken ağrım yok.",
    AGIZ_KURULUGU: "Ağzımda kuruluk hissetmiyorum.",
    TAT_DEGISIKLIGI: "Tat almam normal, değişiklik yok.",
    HALITOZIS: "Kötü ağız kokusu fark etmiyorum.",
    REGURJITASYON: "Mide içeriği ağzıma gelmiyor.",
    GAZ_SISKINLIK: "Hafif gaz ve şişkinlik olabilir, normal.",
    GEGINME: "Normal miktarda geğiriyorum.",
    TENEZM: "Tenezm hissetmiyorum.",
    DISKI_KACIRMA: "Dışkı kaçırmam olmuyor.",
    GENIZ_AKINTISI: "Geniz akıntım yok.",
    BOGAZ_AGRISI: "Boğaz ağrım yok.",
    ORAL_AFT: "Ağzımda yara veya aft yok.",
    DIS_ETI_KANAMA: "Diş etlerimde kanama olmuyor.",
    ANUS_KASINTI: "Anüs bölgemde kaşıntı yok.",
    SIKAYET: "Ana şikayetim belirtildiği gibi.",
    SIKAYET_SURE: "Şikayetim belirttiğim süredir devam ediyor.",
    SARILIK: "Sarılık geçirmedim.",
    ANEMI_HIKAYESI: "Anemi tanım veya hikayem yok.",
    LENFADENOPATI: "Lenf bezlerimde şişme fark etmedim.",
    KOLAY_MORARMA: "Kolay morarma veya kanama eğilimim yok.",
    LAKTASYON: "Laktasyon veya galaktore sorunum yok.",
    MEME_BASI_DEGISIM: "Meme başlarımda değişiklik fark etmedim.",
    JINEKOMASTI: "Jinekomasti yok.",
    VUCUT_GELISIM: "Vücut gelişimim normal.",
    SAC_KIL_DAGILIM: "Saç ve kıl dağılımım normal.",
    GUATR: "Guatrım yok.",
    KAH_OYKUSU: "Koroner arter hastalığım yok.",
    HEPATIT_OYKUSU: "Hepatit geçirmedim.",
    TBC_OYKUSU: "Tüberküloz geçirmedim.",
    KANSER_OYKUSU: "Kanser tanım veya öyküm yok.",
    PSIKIYATRIK: "Psikiyatrik rahatsızlığım yok.",
    ENFEKSIYON_OYKUSU: "Bilinen geçirilmiş enfeksiyonum yok.",
    TRANSFUZYON: "Kan veya kan ürünü transfüzyonu almadım.",
    DIGER_MADDE: "Başka madde kullanmıyorum.",
    ASILAR: "Aşılarımı düzenli yaptırıyorum.",
    COVID_ASI: "COVID-19 aşılarımı oldum.",
    SOY_DIYABET: "Ailede diyabet olan yok.",
    SOY_HT: "Ailede tansiyon yüksekliği olan var mı hatırlamıyorum.",
    SOY_KALP: "Ailede kalp hastalığı olan yok.",
    SOY_KANSER: "Ailede kanser öyküsü yok.",
    SOY_BÖBREK: "Ailede böbrek hastalığı olan yok.",
    SOY_ASTIM: "Ailede astım veya KOAH olan yok.",
    SOY_TBC: "Ailede tüberküloz geçiren yok.",
    SOY_PSIKIYATRIK: "Ailede psikiyatrik hastalık olan yok.",
    SOY_GUATR: "Ailede guatr olan yok.",
    SOY_KANAMA: "Ailede kanama bozukluğu olan yok.",
    SOY_SARILIK: "Ailede sarılık geçiren yok.",
    SOY_OLUM: "Ailede bilinmeyen erken ölüm yok.",
    FIZIK_BILINC: "Bilinç açık, koopere.",
    FIZIK_ORYANTASYON: "Oryantasyon tam; zaman, kişi ve mekan oryantasyonu mevcut.",
    FIZIK_UFURUM: "Üfürüm duyulmadı.",
    FIZIK_SOLUNUM: "Yardımcı solunum kasları kullanılmıyor, siyanoz yok.",
    FIZIK_DEFANS: "Defans ve rebound yok.",
    FIZIK_KARACIGER_DALAK: "Karaciğer ve dalak ele gelmiyor.",
    FIZIK_BARSAK: "Barsak sesleri normal, normoaktif.",
    FIZIK_BOYUN_VENOZ: "Boyun venöz dolgunluğu yok.",
    FIZIK_TRAKEA: "Trakea orta hatta, normal pozisyonda.",
    FIZIK_EKSTREMITE: "Ekstremite muayenesi normal.",
    FIZIK_PERIFERIK_NABIZ: "Dorsalis pedis ve tibialis posterior nabızları açık.",
    AKOLIK_DISKI: "Dışkım normal renkte, akolik değil.",
    DISKI_RENK: "Dışkı rengim normal.",
    ISTAHSIZLIK: "İştahım normal.",
    AGRI_KESICI_ICME: "Hayır, ağrı kesici içmedim.", 
    AGRI_KESICI_ETKI: "Ağrı kesici denemedim, o yüzden bilmiyorum.",
    KILO_KAYBI_AYLIK: "Kilo değişimim yok, sabit.",
    KILO_ALIM_AYLIK:  "Kilo değişimim yok, sabit.",
    DIZURI: "Hayır, idrar yaparken yanma hissetmiyorum.",
    POLLAKURI: "İdrar sıklığım normal.",
    IDRAR_RENK: "İdrar rengim normal, berrak.",
    SOLUKLUK: "Cildimde belirgin bir solukluk fark etmedim.",
    DEFANS_REBOUND: "Karın muayenesi yapılmadı.",
    CARPINTI_OYKU: "Çarpıntı hissetmiyorum.",
    YAN_AGRISI: "Yan/böğür ağrım yok.",
    HIPOTANSIYON_SOK: "Tansiyonum normal, şok belirtim yok.",
    TREMOR: "Ellerimde titreme yok.",
    WHEEZING: "Hışıltılı solunumum yok.",
    TETIKLEYICI: "Belirli bir tetikleyici fark etmedim.",
    ASTIM_OYKUSU: "Astım tanım yok.",
    DEHIDRATASYON: "Sıvı kaybım olmadı, yeterince su içiyorum.",
    AKCIGER_ODEM: "Akciğer ödemi bulgum yok, nefesim rahat.",
    TIROID_FIRTINASI: "Ateşim çok yüksek değil, ajite değilim.",
    GOZ_BULGULARI: "Gözlerimde çıkıklık veya çift görme yok.",
    SESSIZ_AKCIGER: "Akciğer seslerim normal, sessiz alan yok.",
    ORTOPNE: "Düz yatabiliyorum, nefes darlığım olmuyor.",
  };

  // Şablonun kendi yanıtları + genel yanıtlar (şablon öncelikli)
  const birlesikYanitlar: Record<string, string> = {
    ...genelYanitlar,
    ...sablon.hastaYanitlari(),
  };
