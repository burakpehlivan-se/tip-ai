import { Rubric, SoruChipi, ChipKategorisi, Seviye, TestSonucu, Hasta, TedaviPlani } from "../types";
...
export const TEDAVI_SABLONLARI: Record<string, TedaviPlani> = {
  stemi: {
...
export const KAYNAKLAR_SABLONLARI: Record<string, string[]> = {
  stemi: [
